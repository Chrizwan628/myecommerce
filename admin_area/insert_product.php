...
<table width="700" height="400" align="center" border="1" bgcolor="#999999">
<tr align="center">
...
<?php
		...
		else
		{
			...
			move_uploaded_file($temp_name1,"product_images\$product-img1") ;
			move_uploaded_file($temp_name1,"product_images\$product-img1") ;
			move_uploaded_file($temp_name1,"product_images\$product-img1") ;

			
		
		$insert_product = "insert into products ( cat_id,brand_id,date,product_title,product_img1,product_img2,
		product_img3,product_price,product_desc,status) values ('$product_cat','$product_brand',NOW(),'$product_title','$product_img1','product_img2','product_img3','$product_price','$product_desc','$status')";
